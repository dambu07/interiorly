...
import CollaboratorSearch from "../callaborator-search";
...
const SettingsForm = () => {
  ...
  const onChangeWorkspaceLogo = async (
    ...
    if (!error) {
      dispatch({
        type: "UPDATE_WORKSPACE",
        payload: { workspace: { logoUrl: data.path }, workspaceId },
      });
      await updateWorkspace({ logoUrl: data.path }, workspaceId);
        ...
        <Alert variant={"destructive"}>
          ...
          <Button
            ...
            onClick={async () => {
              ...
              toast("Successfully deleted your workspae");
